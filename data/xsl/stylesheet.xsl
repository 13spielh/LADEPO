                    ...
                    <div class="container">
                        <div class="row flex">
                            <div class="col-xs-8">
                                ...
                                <h2>Die carmina liminaria des Collegium Poetarum und der Sodalitas litteraria Danubiana.</h2>
                            </div>
                            <div class="col-xs-4">
                                <div class="unilogo">
                                    <div class="language">
                                    ...
                                    <a href="http://www.uni-graz.at" class="unilogo">
                                        <img class="logoUni"
                                            src="https://gams.uni-graz.at/templates/img/logo_uni_graz_4c.jpg"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <xsl:value-of
                                                    select="document('lists.xml')/t:TEI/t:standOff/t:listPerson/t:person[@xml:id = $author]/t:persName[@xml:lang = 'de']"/>
                                                <xsl:text> (</xsl:text>
                                                <xsl:value-of
                                                    select="document('lists.xml')/t:TEI/t:standOff/t:listPerson/t:person[@xml:id = $author]/t:persName[@xml:lang = 'la']"/>
                                                <xsl:text>)</xsl:text>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <xsl:value-of select="//t:sourceDesc/t:ab/t:bibl"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <xsl:value-of
                                                    select="document('lists.xml')/t:TEI/t:standOff/t:listPerson/t:person[@xml:id = $authorc]/t:persName[@xml:lang = 'de']"/>
                                                <xsl:text> (</xsl:text>
                                                <xsl:value-of
                                                    select="document('lists.xml')/t:TEI/t:standOff/t:listPerson/t:person[@xml:id = $authorc]/t:persName[@xml:lang = 'la']"/>
                                                <xsl:text>)</xsl:text>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <xsl:for-each select="//t:span[@ana='genre']">
                                                    <xsl:value-of select="."/>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <xsl:value-of
                                                    select="//t:div/substring(@source, 7, 9)"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="color">Verschlagwortung:</td>
                                            <td>
                                                <xsl:for-each select="//t:span[@ana='keyword']">
                                                    <xsl:value-of select="."/>
                                                    <xsl:if test="position() != last()">
                                                        <xsl:text>, </xsl:text>
                                                    </xsl:if>
    ...
    <xsl:template match="t:persName">
        <a style="text-decoration: none; color: #336354;" href="#" data-toggle="tooltip">
            <xsl:attribute name="title">
                ...
                <xsl:value-of
                    select="document('lists.xml')/t:TEI/t:standOff/t:listPerson/t:person[@xml:id = $persName]/t:persName[@xml:lang = 'de']"
                />
            </xsl:attribute>
            <xsl:value-of select="."/>
        </a>
    ...
    <xsl:template match="t:placeName">
        <a style="text-decoration: none; color: #336354;" href="#" data-toggle="tooltip">
            <xsl:attribute name="title">
                ...
                <xsl:value-of
                    select="document('lists.xml')/t:TEI/t:standOff/t:listPlace/t:place[@xml:id = $placeName]/t:placeName[@xml:lang = 'de']"
                />
            </xsl:attribute>
            <xsl:value-of select="."/>
        </a>
